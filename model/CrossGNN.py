...
class Cross(torch.nn.Module):
    def __init__(self, in_channel=100, kernel_size=100, num_classes=2):
        ...
        num_layers = 1
        self.psi_1  = nn.GRU(input_size=self.d, hidden_size=32, num_layers=num_layers)
        self.psi_2  = nn.GRU(input_size=self.d, hidden_size=32, num_layers=num_layers)
